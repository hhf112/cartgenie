...
export function ItemCard({ itemName, imageUrl, url, site }: itemCardParams) {
  return (
    <div className="min-w-1/2 h-40 flex rounded-xl justify-start items-center border border-gray-300 m-1 shadow-xl overflow-auto text-sm p-2">
      ...
      <div className="w-3/5 flex min-w-0 flex-col justify-start items-start p-2">
        ...
        <p className=" min-w-0 max-w-full my-1 text-left text-neutral-400 whitespace-normal overflow-auto,"> prices may change </p>
        <p className=" my-1 text-left whitespace-normal"> buy now: <a className="whitespace-normal  text-green-300 underline overflow-auto" href={url} target="_blank" > link to product </a> </p>
      </div>
    </div>
  )
